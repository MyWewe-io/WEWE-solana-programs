...
impl<'info> CreateProposal<'info> {
    pub fn handle_create_proposal(
        ...
        // Create metadata account at proposal creation time (mutable)
        let proposal_id_bytes = self.maker_account.proposal_count.to_le_bytes();
        ...
        create_metadata_accounts_v3(
            ...
            true,  // Is mutable - set to true to allow updates until launch/rejection
